...
window.SCENES_DATA = {
  ...
  'study': {
    id: 'study',
    name: '犯罪现场 - 书房',
    description: '书房位于别墅二楼东侧。雨声隔着厚窗压进来，红木书桌正对门口，椅子斜倒在桌边，地毯上没有拖拽痕。桌面摊开《山居笔记》，半杯冷茶停在右手边；如果这是心脏病发作，现场太安静了。',
    ...
    items: [
      {
        ...
        name: '书桌',
        icon: '📚',
        description: '红木书桌上摊着《山居笔记》，毛笔压在砚台边，几份公司文件被匆忙推到一旁。右侧抽屉没有锁严，露出一截白色标签。',
      ...
      },
      {
        ...
        description: '这本明抄本保存得很好，批注多为深褐旧墨。第47页被书签夹住，纸边比其他页略硬。',
        puzzle: {
          type: 'multi-click',
          required: 3,
          stages: [
            '你先翻看前后几页：旧批注渗进纸纤维，边缘发毛，颜色沉下去。',
            '第47页那行小字不一样。墨色浅半分，笔画边缘更亮，像干得比旧墨慢。',
            '你隔着手套轻触纸面，批注处有轻微黏滞感。若陈墨白翻页前会舔手指，这一页就是必须送检的接触点。'
          ]
        },
        clueDetail: '第47页的批注墨迹与其他页面不同，颜色更浅，触感也更黏。它本身还不能定案，但足以成为重点送检对象。',
        clues: ['C06']
      },
      {
        id: 'teacup',
        ...
        clueDetail: '茶水颜色、气味和杯底残留都符合普通龙井茶特征，未见沉淀或异味。茶水路线暂时排除。',
        clues: ['I14']
      },
      {
        id: 'file-cabinet',
      ...
      },
      {
        ...
        puzzle: {
          type: 'password',
          hint: '请输入保险箱密码（8位数字）。提示：陈墨白习惯用自己的出生日期，客厅画像铭牌上有完整日期。',
      ...
      },
      {
        ...
        name: '方志远的外套',
        icon: '🧥',
        description: '衣架上挂着一件深色西装外套，肩线被雨水压得发塌。内袋鼓起一角，手机屏幕还亮着。',
        clueDetail: '手机里有赌博应用的催款通知，近三日转账频繁。方志远不是单纯紧张，他确实急需现金。',
        clues: ['I01']
      },
      {
        id: 'wall-quote',
  ...
  'bedrooms': {
    ...
    items: [
      ...
      },
      {
        ...
        clueDetail: '手提包里有酒店收据和暧昧短信，这些材料指向一段隐秘关系......',
        clues: ['I09', 'I10']
      },
      {
        id: 'corridor-board',
    ...
    items: [
      {
        ...
        puzzle: {
          ...
          required: 3,
          stages: [
            '一株开着紫色小花的植物，标签上写着"乌头草（Aconitum）- 实验样本"。花盆外观普通，土面却有被重新压平的痕迹......',
  ...
  'office': {
    ...
    items: [
      ...
      },
      {
        ...
        name: '笔记本电脑',
        icon: '💻',
        description: '办公桌上的笔记本电脑处于待机状态。桌上的便签纸上写着："系统密码：父亲的生日"。',
      ...
      },
      {
        ...
        name: '照片',
        icon: '📷',
        description: '桌角有一个小小的相框，照片里是一个中年男人抱着一个小女孩。照片背面写着"赵明远，1974-2004"。',
        clues: ['B07']
      },
      {
        id: 'certificate-wall',
      ...
      },
      {
        ...
        requiresClue: 'C02',
        requiresClueHint: '这本书外观普通，但书脊的折痕说明经常被抽出。你需要了解更多关于赵雅琴的背景，才能理解为什么这本书如此重要。',
        puzzle: {
          type: 'multi-click',
          required: 3,
          stages: [
        ...
        clueDetail: '书架移开后，露出了一个旧铁盒。里面有一封泛黄遗书和一本用布包着的日记本，纸页边缘被反复翻过。',
        clues: ['C01', 'C17']
      }
    ]
  },
    ...
    items: [
      {
        ...
        icon: '📜',
        image: 'item-ancient-book.jpg',
        description: '阅读台上摊开的古籍，正是陈墨白死前正在研究的那本。第47页夹着送检标签，旁边放着指纹粉和透明胶片。',
        puzzle: {
          type: 'inspect',
          hint: '检查第47页附近的痕迹，确认谁反复接触过这一页。',
          required: 3,
          points: [
            { label: '页边指纹', note: '陈墨白的指纹分布在全书多处，符合日常翻阅。' },
            { label: '批注旁指纹', note: '赵雅琴的指纹集中在第47页批注附近。' },
            { label: '送检标签', note: '标签只标出第47页，说明这里的墨迹和接触痕迹最集中。' }
          ],
          success: '指纹比对完成：赵雅琴曾重点接触第47页。'
        },
        clueDetail: '古籍上检测出了两组指纹：陈墨白的指纹分布在全书各处，赵雅琴的指纹主要集中在第47页附近。',
        clues: ['C06', 'I15']
      },
      {
        id: 'repair-archive',
      ...
      },
      {
        ...
        puzzle: {
          type: 'match',
          hint: '将旧摹本与现本差异对应起来，确认新增批注的位置。',
          leftTitle: '比对结果',
          rightTitle: '含义',
          pairs: [
            { left: '旧摹本第47页留白', right: '现本新增批注不是原书内容。' },
            { left: '现本多出一行小字', right: '新增内容正位于死者最后翻阅页。' },
            { left: '字形刻意仿旧', right: '新增者熟悉古籍修复和仿写。' }
          ],
          rightOrder: [1, 2, 0],
          success: '旧摹本比对完成：第47页确有后补批注。'
        },
        clueDetail: '旧摹本显示，第47页原本没有现本上那行新批注；新增文字模仿得很像，但位置和墨色都对不上旧本。',
        clues: ['B16']
      }
    ]
  },
    ...
    items: [
      ...
      },
      {
        ...
        puzzle: {
          ...
          required: 2,
          stages: [
            '柜子里放着枸杞、黄芪、当归等常见药材。角落里另有一包附子，标签写着"附子-乌头炮制品"。等等，乌头？',
    ...
    items: [
      {
        ...
        requiresClues: ['I13', 'I14', 'C06'],
        requiresClueHint: '系统需要至少三类现场依据：药物排查、茶水排查和异常墨迹。先把第一现场的基础证据带回来。',
        puzzle: {
          type: 'match',
